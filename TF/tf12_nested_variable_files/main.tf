...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "48046f15-4797-49a7-8c13-2532b059c50a"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "480eea1d-9745-432b-87b5-c59f4a635a83"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "22a596fc-8a96-44d9-84e9-dad1578511b9"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    Env       = "prod"
    yor_trace = "acb52dcc-e4a2-45e7-a81c-09f8954cd0d5"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "35845dc5-9e23-4fe0-812e-fb7e72a3fbd0"
  }
}
