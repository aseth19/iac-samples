...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "aac4fb27-3656-4358-9d4e-56897f16056c"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "84a1a15e-138f-4dfc-abe7-99b08f78dee8"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "a0fac9c6-af76-4717-9aae-156b2f1f45d0"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "c388ab94-702b-4d35-ae83-4be6600524dc"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "8ad2e0c2-3d98-4af5-933d-93b8850d309b"
  }
}
