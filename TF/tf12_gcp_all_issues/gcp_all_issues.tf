...
resource "google_storage_bucket" "static-site" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "2d40df41-c4c5-4102-8c3c-7586776adb74"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "06820d5d-c630-4a19-918e-02c92ab9b6a3"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "50d78360-e849-481e-8993-c9831584e6f3"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    Env         = "prod"
    yor_trace   = "6cbedfd8-40bd-48f3-a7ef-2128520e3b89"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "268bb2bd-f426-46c1-a2b3-2fc84b310100"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "fc52aa31-47c0-4f71-8086-ed86de878a3e"
  }
}
