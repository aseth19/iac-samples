...
resource "google_storage_bucket" "static-site" {
  ...
  //  }
  labels = {
    yor_trace = "ffc4870f-bf7f-487e-8c2e-2498fffc21a0"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    yor_trace = "36e663d1-af9f-42b7-888a-89c402010ea6"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    yor_trace = "569ff58e-c682-4650-9c36-a5592ab172ff"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    yor_trace   = "7729c03b-1577-468e-81a7-25e4f650fab5"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    yor_trace = "0cd3b7f2-f593-422f-b00a-6a77b2e5c465"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    yor_trace = "bcd949a0-df36-4920-b2e9-cf4385003696"
  }
}
