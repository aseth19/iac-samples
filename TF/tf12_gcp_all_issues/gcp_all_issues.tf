...
resource "google_storage_bucket" "static-site" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "7c6230fd-7faf-45ea-a448-0990783f2b67"
  }
}
...
resource "google_storage_bucket" "bucket" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "4855da8c-29a9-4ab3-989a-e129a2038baa"
  }
}
...
resource "google_compute_instance" "apps" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "9a49cf8c-2c16-4c1d-b759-d915a9dd2297"
  }
}
...
resource "google_compute_disk" "default" {
  ...
  labels = {
    environment = "dev"
    Env         = "prod"
    yor_trace   = "29fa9944-c249-42b4-bcbf-74f12659c386"
  }
...
resource "google_compute_instance_template" "instance_template" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "ae8839e8-4d0d-444b-a241-bb29a9fc8007"
  }
}
...
resource "google_project" "my_project" {
  ...
  labels = {
    Env       = "prod"
    yor_trace = "1455dcfd-1bc7-4333-a021-afa68dbbe887"
  }
}
