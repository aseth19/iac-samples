...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "7daddbae-c583-43c6-8c36-8e26471b87e5"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "ae477d48-b3dd-4fda-9928-c90fb4671455"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "7f92acaa-41b0-405c-a58b-ea79c1a35904"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "1ef5e6f8-de06-467a-8311-170f1809115f"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "b003e378-df0f-4bd8-b860-800e02566197"
  }
}
