...
resource "aws_vpc" "my_vpc" {
  ...
  tags = {
    ...
    yor_trace = "8affdb3e-663d-4d41-96ed-259a47862b76"
  }
}
...
resource "aws_s3_bucket" "publics3" {
  ...
  tags = {
    yor_trace = "e5ed2395-c68c-40b2-94f7-22218a714eec"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "2e8ef4c8-d36d-440e-81e9-67f1a538e845"
  }
}
...
resource "aws_subnet" "my_subnet" {
  ...
  tags = {
    Name      = "tf-0.12-for-example"
    yor_trace = "3affada2-20fd-48af-aa87-83615ae28a2e"
  }
}
...
resource "aws_instance" "ubuntu" {
  ...
  tags = {
    ...
    yor_trace = "c6d58583-1cec-4cb7-8540-992a4706677b"
  }
}
