...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "459594ed-c929-445d-b363-14d179cf6b9e"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "dca1e44f-c498-4c2c-94eb-b5cfcb9a2424"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "cf23ea8a-9c91-4066-92e7-d34fdaafeb30"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "be738ef7-cec7-430d-8483-6b6905c2a9a3"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "d5cc9108-1a79-4fc2-900c-5fbf6c72f137"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    Env       = "prod"
    yor_trace = "8426b59f-4167-4301-bd0f-b8969a4e6788"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "f96c9c9b-0fc2-415b-8ae4-6f610c46e9fb"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "90f27f62-95f6-4fcf-aa01-eeea9c15e7fa"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "b17ee629-1c40-49b8-8bae-b2d7d97ba593"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "9cab3fff-1c80-4dcd-8455-305c90f3f2d5"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "fe4959c1-2ab9-47d0-b754-b145db4b9bb5"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "f743d374-f11e-4f10-b7dc-ede4580f97c8"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "342e9fb8-64c6-44b7-a97d-5b889d725b7b"
  }
}
...
resource "aws_sns_topic" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5c2ab1b3-5c22-46f4-ac51-52f9463e4b3a"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5fb746a0-bec4-48c1-97e9-31cb533cf991"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "50934812-1949-409d-b661-345b1e182253"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "8f60d320-114d-4d43-a66b-623c34e61015"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "18b99407-00c0-4b24-a274-bcf1f76bbea5"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "06c3c334-960b-424f-b469-ff802af7d36a"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5fdec5e7-bb43-42d6-a7f6-05e5518c9def"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "5012b019-d1dc-426c-bfc7-1c21d4dea73a"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  tags = {
    Env       = "prod"
    yor_trace = "63a5bacc-84d7-430f-b8d4-f16625ed130e"
  }
}