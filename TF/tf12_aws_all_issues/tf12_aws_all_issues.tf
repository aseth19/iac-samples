...
resource "aws_s3_bucket" "log_bucket" {
  ...
  tags = {
    yor_trace = "a0c6d022-3b11-41f9-b551-fb6f202bf10b"
  }
}
resource "aws_s3_bucket" "foo" {
  ...
  tags = {
    yor_trace = "4f5ba694-1d60-4cb9-ac17-aa268ad37571"
  }
}
...
resource "aws_cloudtrail" "foo_cloudtrail" {
  ...
  tags = {
    yor_trace = "5e158358-1ba5-4df5-9a8c-f386f040f108"
  }
}
...
resource "aws_vpc_peering_connection" "foo" {
  ...
  tags = {
    yor_trace = "ed54c348-fed8-4662-9999-7bc4df205743"
  }
}
resource "aws_vpc" "foo_vpc" {
  ...
  tags = {
    ...
    yor_trace = "e1c91233-0e97-4819-8b42-5d25afde1bf4"
  }
}
resource "aws_vpc" "bar_vpc" {
  ...
  tags = {
    ...
    yor_trace = "e1ef9eb3-8f04-440f-a787-8e6d909566fe"
  }
}
...
resource "aws_security_group" "allow_tcp" {
  ...
  tags = {
    yor_trace = "d7da2a72-be6f-4f72-91e0-b62f89aec39e"
  }
}
...
resource "aws_security_group" "allow_rdp" {
  ...
  tags = {
    yor_trace = "06453ada-12ff-4749-86cd-cabf36a36aab"
  }
}
...
resource "aws_security_group" "allow_all_traffic" {
  ...
  tags = {
    yor_trace = "8462d524-098c-49dc-9ad5-92f459187ce8"
  }
}
...
resource "aws_security_group" "allow_udp69" {
  ...
  tags = {
    yor_trace = "7cd59b18-48b0-431f-8471-0e2946d425e3"
  }
}
...
resource "aws_network_acl" "main" {
  ...
  tags = {
    yor_trace = "934f1c1e-faee-4614-a3d2-a950649ed791"
  }
}
...
resource "aws_redshift_parameter_group" "bar" {
  ...
  tags = {
    yor_trace = "ce3a72f7-63b2-42c1-8dfc-a1b8540831bd"
  }
}
...
resource "aws_db_instance" "default" {
  ...
  tags = {
    yor_trace = "d44590f5-63bb-4f70-84d8-5395d22d1840"
  }
}
...
resource "aws_sns_topic" "default" {
  name = "rds-events"
  tags = {
    yor_trace = "f55246d1-d9b9-4385-b582-050bc6221029"
  }
}
resource "aws_db_event_subscription" "default" {
  ...
  enabled = false
  tags = {
    yor_trace = "acf4daac-eebe-47b5-9147-4ef3d55bd92c"
  }
}
...
resource "aws_kms_key" "a" {
  ...
  tags = {
    yor_trace = "ecddf5a3-5f42-4186-b028-0550343d8d62"
  }
}
...
resource "aws_vpc" "mainvpc" {
  ...
  tags = {
    yor_trace = "d9a98f5b-a452-4bdd-acde-c44e98776605"
  }
}
resource "aws_default_security_group" "default" {
  ...
  tags = {
    yor_trace = "51a54811-1d5c-4ee5-9974-d515d5d6bd9b"
  }
}
...
resource "aws_ecs_task_definition" "github-backup" {
  ...
  DEFINITION
  tags = {
    yor_trace = "e388cc9e-908f-47a8-a212-3f0cb735a8e3"
  }
}
resource "aws_ecs_task_definition" "github-backup2" {
  ...
  DEFINITION
  tags = {
    yor_trace = "76891305-62aa-42fb-a1f0-765d96337419"
  }
}
...
resource "aws_elasticsearch_domain" "example" {
  ...
  tags = {
    yor_trace = "0c6e4a6e-14c5-40f6-bf84-dde140f0d21e"
  }
}
...
resource "aws_eks_cluster" "example" {
  ...
  version = "1.9.9"
  tags = {
    yor_trace = "0c7ce5e4-c2f9-4747-9176-99c09da4c3a2"
  }
}